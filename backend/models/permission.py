...
class RoleDepartmentDefault(Base):
    """
    Default permissions for a role + department combination.
    This takes precedence over RoleDefault.
    """
    __tablename__ = "role_department_defaults"
    ...
    __table_args__ = (
        UniqueConstraint('role', 'department', 'feature_key', name='uix_role_dept_default'),
    )
